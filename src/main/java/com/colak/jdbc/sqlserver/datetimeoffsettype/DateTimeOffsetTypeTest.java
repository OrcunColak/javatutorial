package com.colak.jdbc.sqlserver.datetimeoffsettype;
...
@Slf4j
public class DateTimeOffsetTypeTest {
    ...
    private static void insertAsOffsetDateTime(Connection connection) throws SQLException {
        String insertQuery = "INSERT INTO " + TABLE_NAME + " (datetimeoffset_column) VALUES (?)";
    ...
    private static void selectAsOffsetDateTime(Connection connection) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(insertQuery);
            ...
            resultSet.next();
            OffsetDateTime offsetDateTime = resultSet.getObject("datetimeoffset_column", OffsetDateTime.class);

            // offsetDateTime : 2022-02-06T13:01:05.123+03:00
    ...
    private static void selectAsZonedDateTime(Connection connection) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(insertQuery);
            ...
            ZonedDateTime zonedDateTime = resultSet.getObject("datetimeoffset_column", ZonedDateTime.class);
